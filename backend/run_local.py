...
def get_issues_data():
    ...
    try:
        ...
        cursor.execute('''
            ...
            FROM processed_records 
            WHERE quality_level IN ('low', 'medium') OR quality_score < 80
                ...
                if check.get('status') == 'fail':
                    issues.append({
                        ...
                        'record': {
                            ...
                            'priority': 'high' if quality_score < 50 else 'medium',
                            'createdAt': created_at,
                            'title': title,
                            'qualityScore': quality_score
                        }
    ...
    try:
        for answer in request.answers:
            ...
            standard_record = {
                ...
                "content": processed_record.content,
...
async def get_filter_options():
    ...
    return {
        ...
        "statuses": [
            ...
            {"value": "under_review", "label": "Medium Quality Records", "count": 89},
        ],
        "priorities": [
    ...
    if RULES_ENGINE_AVAILABLE:
        try:
            ...
            test_request = RulesCheckRequest(
                content="This is a comprehensive guide about software development best practices.",
...
async def get_review_queue(priority: Optional[str] = None, assigned_to: Optional[str] = None):
    ...
    try:
        ...
        if assigned_to:
            ...
            cursor.execute(query, [f'%{assigned_to}%'])
        else:
